...
export default function Reportes() {
  ...
  return (
    <div className="reportes-container">
      ...
      <div className="reporte-seccion">
        ...
        <div className="tabla-container">
          <table className="tabla-reporte">
            ...
            <tfoot>
              {(() => {
                const totalDecididos = comerciales.totales.aprobado + comerciales.totales.rechazado;
                const tasaCierreTotal = totalDecididos > 0 ? ((comerciales.totales.aprobado / totalDecididos) * 100).toFixed(1) : '-';
                return (
                  <tr className="fila-totales">
                    <td>TOTAL</td>
      ...
      {/* Distribución por Local (fecha de carga) */}
      {locales?.filas?.length > 0 && (
        <div className="reporte-seccion">
          <div className="seccion-header">
            <h2>Distribución por Local</h2>
            <p className="seccion-desc">
              Eventos por fecha de carga y local. Permite medir dónde la pauta está siendo más efectiva.
            </p>
          </div>
          <div className="tabla-container">
            <table className="tabla-reporte tabla-locales">
              <thead>
                <tr>
                  <th>Fecha carga</th>
